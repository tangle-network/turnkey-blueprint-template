...
impl CreateSubOrganizationIntentV3 {
    pub fn new(sub_organization_name: String, root_users: Vec<models::RootUserParams>, root_quorum_threshold: i32, private_keys: Vec<models::PrivateKeyParams>) -> CreateSubOrganizationIntentV3 {
