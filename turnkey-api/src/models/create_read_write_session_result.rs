...
impl CreateReadWriteSessionResult {
    pub fn new(organization_id: String, organization_name: String, user_id: String, username: String, api_key_id: String, credential_bundle: String) -> CreateReadWriteSessionResult {
