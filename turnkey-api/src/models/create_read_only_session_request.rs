...
impl CreateReadOnlySessionRequest {
    pub fn new(r#type: Type, timestamp_ms: String, organization_id: String, parameters: serde_json::Value) -> CreateReadOnlySessionRequest {
