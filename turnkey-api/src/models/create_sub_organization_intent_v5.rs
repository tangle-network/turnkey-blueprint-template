...
pub struct CreateSubOrganizationIntentV5 {
    ...
    pub root_users: Vec<models::RootUserParamsV2>,
...
impl CreateSubOrganizationIntentV5 {
    pub fn new(sub_organization_name: String, root_users: Vec<models::RootUserParamsV2>, root_quorum_threshold: i32) -> CreateSubOrganizationIntentV5 {
